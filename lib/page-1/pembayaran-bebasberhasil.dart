...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // pembayaranbebasberhasilc6J (202:716)
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 22.68*fem,
                    child: Image.asset(
                      'assets/page-1/images/left-side-422.png',
                      width: 58.32*fem,
                      height: 22.68*fem,
                    ),
                  ),
                  Container(
                    ...
                    height: 13.07*fem,
                    child: Image.asset(
                      'assets/page-1/images/frame-p4N.png',
                      width: 78.77*fem,
                      height: 13.07*fem,
                    ),
                  ),
            ...
            Container(
              // autogroupgr4eRT4 (DKUbibw4bNU4cDYRdsGR4E)
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: TextButton(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              // evaarrowbackoutline1w4 (202:730)
                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 22.17*fem, 0*fem),
                              width: 28.67*fem,
                              height: 25.09*fem,
                              child: Image.asset(
                                'assets/page-1/images/eva-arrow-back-outline-xDc.png',
                                width: 28.67*fem,
                                height: 25.09*fem,
                              ),
                            ),
                            Container(
                              // pembayaranberhasilXPc (202:729)
                  ...
                  Container(
                    // epsuccessfilledZ5Q (205:1018)
                    margin: EdgeInsets.fromLTRB(151.63*fem, 0*fem, 0*fem, 32.63*fem),
                    width: 148.75*fem,
                    height: 148.75*fem,
                    child: Image.asset(
                      'assets/page-1/images/ep-success-filled-Q8W.png',
                      width: 148.75*fem,
                      height: 148.75*fem,
                    ),
                  ),
                  Container(
                    // keterangan5ZY (202:756)
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          // autogroupfseeYi2 (DKUc1WcZCXMe42SA3KfSEE)
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                // anaksayaizindikarenakanadaacar (202:760)
                                left: 0*fem,
                                top: 30*fem,
                                child: Align(
                                  child: SizedBox(
                              ...
                              Positioned(
                                // pembayaranberhasilterimakasiha (205:1023)
                                left: 22*fem,
                                top: 0*fem,
                                child: Align(
                                  child: SizedBox(
                        ...
                        Container(
                          // group33345NKg (202:757)
                          width: 395*fem,
                          height: 1.04*fem,
                          child: Image.asset(
                            'assets/page-1/images/group-33345-Tci.png',
                            width: 395*fem,
                            height: 1.04*fem,
                          ),
                        ),
                  ...
                  Container(
                    // autogroupy2nnJj8 (DKUbNHBbMQMVqUtpP6y2nn)
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Positioned(
                                        // icbaselineuploadfile19g (202:768)
                                        left: 85*fem,
                                        top: 4*fem,
                                        child: Align(
                                          child: SizedBox(
                                            ...
                                            height: 20*fem,
                                            child: Image.asset(
                                              'assets/page-1/images/ic-baseline-upload-file-wJE.png',
                                              width: 16*fem,
                                              height: 20*fem,
                                            ),
                                          ),
                                ...
                                Container(
                                  // group33345UZ4 (202:763)
                                  margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 0*fem, 0*fem),
                                  width: 395*fem,
                                  height: 1.04*fem,
                                  child: Image.asset(
                                    'assets/page-1/images/group-33345-uJ6.png',
                                    width: 395*fem,
                                    height: 1.04*fem,
                                  ),
                                ),
